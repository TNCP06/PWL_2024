...
class UserController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            // dan berniliai unik di tabel m_user kolom username kecuali untuk user dengan id yang sedang diedit
    ...
    public function store_ajax(Request $request)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            // Jika validasi gagal
            if ($validator->fails()) {
                // Catat kesalahan ke log file
                Log::info('Kesalahan Validasi: ', $validator->errors()->toArray());
                // Anda juga bisa mencatat kesalahan secara lebih terperinci dengan menambahkan tambahan informasi
                Log::info('Input yang gagal:', $request->all());
